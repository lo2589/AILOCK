...
from aloc.fileops import atomic_write
...
class AtomicWritePermissionTests(unittest.TestCase):
    def test_atomic_write_preserves_executable_mode(self):
        with tempfile.TemporaryDirectory(prefix="ailock-mode-exec-") as temp_dir:
    ...
    def test_atomic_write_preserves_private_mode(self):
        with tempfile.TemporaryDirectory(prefix="ailock-mode-private-") as temp_dir:
    ...
    def test_atomic_write_creates_new_file(self):
        with tempfile.TemporaryDirectory(prefix="ailock-mode-new-") as temp_dir:
